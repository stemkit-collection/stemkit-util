...
"
" Modifications: Keith Roberts <cppwriter@yahoo.com>
"    No longer operates on "words" mode.  Originally 
"    took all words pass and looked for \<(w1|w2|w3)\>
"    Now looks for (w1 w2 w3) if you pass w1\ w2\ w3
"    To get original behavior, don't excape the spaces
"    To get original word boundary behavior, add \< and \>
"    Proper regex support now
"
